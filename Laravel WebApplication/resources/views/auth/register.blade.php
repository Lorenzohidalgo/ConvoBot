                ...
                <div class="row">
                    ...
                    <div class="col-10">
                         ...
                         <div class="form-group row">
                            <div class="col-md-12">
                                <input id="name" type="text"  placeholder="{{ __('Full Name') }}"  class="form-control @error('name') is-invalid @enderror authInput" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>    
                                    @error('name')
